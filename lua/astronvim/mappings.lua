...
-- Disable arrow keys
maps.n["<Up>"] = { "<nop>", desc = "Disable Up Arrow" }
maps.n["<Down>"] = { "<nop>", desc = "Disable Down Arrow" }
maps.n["<Left>"] = { "<nop>", desc = "Disable Left Arrow" }
maps.n["<Right>"] = { "<nop>", desc = "Disable Right Arrow" }
